...
--
-- Host: 127.0.0.1
-- Tempo de geração: 14/09/2026 às 00:37
...
VALUES (
        ...
        'uploads/animais/animal_6aa49d4252205.jpg'
    ),
    (
        2,
        'Mininha',
        ...
        'filhote',
        'saudavel ligeira',
        'uploads/animais/animal_6aa49da49ef5b.jpg'
    ),
    (
        3,
        'Pepito',
        ...
        'filhote',
        'muito saudavel ',
        'uploads/animais/animal_6aa49d38e8041.jpg'
    ),
    (
        4,
        'Gatão',
        ...
        'adulto',
        'saudavel ligeira',
        'uploads/animais/animal_6aa49d9b32e8d.jpg'
    ),
    (
        5,
        'Chiquinha',
        ...
        'filhote',
        'muito saudavel',
        'uploads/animais/animal_6aa49cc20ec92.jpg'
    ),
    (
        6,
        'Princesa',
        ...
        'filhote',
        'muito saudavel',
        'uploads/animais/animal_6aa49c84ebcdd.jpg'
    ),
    (
        7,
        'xiquita',
        ...
        '2026-09-11',
        'filhote',
        'ela é RN esta perfeita!',
        'uploads/animais/animal_6aa49b869d999.jpg'
    );
...
VALUES (
    ...
    (
        ...
        0.00,
        '2026-09-09',
        'pacote de ração 12kg premium carne',
        'pendente',
        NULL,
        NULL,
        NULL,
...
VALUES (
    ...
    (
        ...
        '$2y$10$D2ODEdvfzU1CwcfywqikqeSTLeWXKIxMrAJZR0Tx/3LpCXTGQogdy',
        NULL,
        NULL,
        3
    ),
    (
        ...
        'rua teste01 01',
        '13996325411',
        'leandromunhozmotta@gmail.com',
        '$2y$10$J3Rl41i79OJfoXNOOt7zH.Z1bEaqz5FNjiqmB22pRUkk.btM9iWoa',
        NULL,
        NULL,
        2
    ),
    (
        ...
        '$2y$10$ErI.rDiOLDUkZWtcpEtNgeZWsGPyeusm72df8V8p4wWqZffFUJV8C',
        NULL,
        NULL,
        1
    ),
    (
        ...
        'Marlene da Silva',
        '1980-10-05',
        'Rua da Imaginação 200',
        '13974011122',
        'marlene_silva@gmail.com',
        '$2y$10$fD9rugBElJrsnrueQLkZSOVHf4ngFWZ3OqxSdXe1p0wiUZl5mFPDO',
        NULL,
        NULL,
        4
    );
...
--
ALTER TABLE `animais` ADD PRIMARY KEY (`id_animal`);
